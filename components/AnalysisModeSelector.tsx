...
export function AnalysisModeSelector({
  ...
  const requiresRepoPath = mode === 'blame' || mode === 'commits' || mode === 'hybrid';
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 space-y-6">
      <div>
        ...
        <div className="mb-4">
          ...
          >
            ...
            <option value="github-api">
              GitHub API - Metadata Only
            </option>
            <option value="hybrid">
              Hybrid - All Combined
            </option>
          ...
          <p className="text-xs text-gray-500 mt-1">
            {mode === 'blame' && '✅ Accurate line-level attribution, ignores merges'}
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md p-4">
        <h3 className="font-semibold text-sm mb-2">About {mode.charAt(0).toUpperCase() + mode.slice(1)} Mode</h3>
